...
public class ClinVarGeneStatsTest {
    ...
    public void testEmptyBuilder() {
        ClinVarGeneStats stats = ClinVarGeneStats.builder().build();

        assertThat(stats.variantEffectCounts(), equalTo(Collections.emptyMap()));
    }
    ...
    public void testBuilderWithValues() {
        ...
        assertThat(stats.variantEffectCounts(), equalTo(Map.of(variantEffect, expectedMap)));
    }
...
//        System.out.println(stats.getInnerMap());
        assertThat(stats.variantEffectCounts(), equalTo(Map.of(variantEffect1, expectedMap1)));
    }
